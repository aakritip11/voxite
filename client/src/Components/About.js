    ...
    return(
        <div className="about">
            <div className="about--container">
                <div data-aos="fade-right" className="about--textDiv">
                  <h1 data-aos="fade-up" className="about--homeTitle">
                    ...
                    <p className="about--p">Welcome to Travel N Tourism! We are a dedicated team of travel enthusiasts passionate about creating exceptional travel experiences for our clients. Whether you're looking for a relaxing beach getaway, an adventurous trek through mountains, or a cultural immersion in vibrant cities, we have you covered.</p>
                </div>
                <div data-aos="fade-up" className="about--imageDiv">
                    <img src={img3} />
                    <img src={img4} />
                    <img src={img5} />
                </div>
